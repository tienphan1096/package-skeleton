...
searchDirectoryFiles(getcwd() . '/', 'my-first-package', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'MyFirstPackage', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'My First Package', dashesToCamelCase($argv[1], true, ' '));
